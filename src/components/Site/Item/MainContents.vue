                ...
                <div class="flex grid grid-cols-12">
                    ...
                    <div class="col-span-6 p-4">
                        ...
                        <div class="flex text-center  text-gray-600 border-b border-t py-4 border-gray-100">
                            ...
                            <span class="">
                                <p class="inline-flex py-0.5 px-3 font-bold items-center rounded text-xxxs bg-red-200 text-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">- {{ product.item.percentage_charge }}%</p>
                            </span>
                        </div>
                        <!-- End item price -->
