<template>
    ...
    <!-- Begin contents -->
    <main class="2xl:container xl:container lg:container 2xl:my-4 xl:my-4 lg:my-4 mx-auto">
            ...
            <section class="bg-white rounded">
                <div class="flex grid grid-cols-12">
                    ...
                    <div class="col-span-4 p-4">
                        <div class="justify-center items-center border border-gray-100 rounded mb-2"><img :src="items.items[1].image" alt="" class="rounded"></div>
                        <div class="flex justify-center items-center rounded border border-gray-100"><a v-for="image in items.items" :key="image.resource_id" href="#" class=""><img :src="image.image" alt="" class="rounded"></a></div>
                    </div>
                    <!-- End item images -->
                    ...
                    <div class="col-span-6 p-4">
                        ...
                        <div class="">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="flex gap-2">
                                    <div class="flex cursor-pointer"><div class="w-10 text-center rounded-md border border-gray-300 py-1.5 hover:border-red-500 active:shadow-md">S</div></div>
                                    <div class="flex cursor-pointer"><div class="w-10 text-center rounded-md border border-gray-300 py-1.5 hover:border-red-500 active:shadow-md">M</div></div>
                                    <div class="flex cursor-pointer"><div class="w-10 text-center rounded-md border border-gray-300 py-1.5 hover:border-red-500 active:shadow-md">L</div></div>
                                    <div class="flex cursor-pointer"><div class="w-10 text-center rounded-md border border-gray-300 py-1.5 hover:border-red-500 active:shadow-md">XL</div></div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 mt-2">
                                        <span class="text-gray-400 text-xs">797 pieces available</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End quantity -->
                            ...
                            <!-- Begin delivery info -->
                            <div class="mt-5">
                                <p class="font-bold text-sm">Shipping: GHS 130.21</p>
                    ...
                    <div class="w-full">
                        ...
                        <div class="sticky top-20 z-40 border-t">
                            <ul class="flex mb-0 list-none flex-wrap flex-row">
                                ...
                                <li class="-mb-px last:mr-0 flex-auto text-center cursor-pointer"><a class="text-sm font-bold px-3 py-2 block leading-normal border-b" @click="toggleTabs(3)" v-bind:class="{'text-gray-600 bg-white': tabs.openTab !== 3, 'text-gray-500 bg-gray-200': tabs.openTab === 3}">Specifications</a></li>
                            </ul>
                        </div>
                        <!-- End tab menu -->
...
<style lang="scss" scoped>
    ...
    .custom-number-input input:focus { outline: none !important; }
    .custom-number-input button:focus { outline: none !important; }
