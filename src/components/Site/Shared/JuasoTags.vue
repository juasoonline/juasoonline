<template>
    ...
    <section class="2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden w-full mb-5">
        <div class="flex flex-col grid gap-3 grid-cols-4">
            ...
            <div class="flex 2xl:p-6 xl:p-4 lg:p-2 bg-white rounded">
                <div class="flex-shrink-0">
                    <div class="flex items-center justify-center rounded-full text-white bg-juaso-primary 2xl:p-4 xl:p-3 lg:p-2">
                        <svg class="2xl:w-5 xl:w-4 lg:w-3 2xl:h-5 xl:4 lg:h-3 rounded-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16"></path></svg>
                    </div>
                </div>
                <div class="ml-4">
