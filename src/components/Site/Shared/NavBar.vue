<template>
    ...
    <!-- Begin contents -->
    <div class="flex bg-gray-50 2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden">
                ...
                <nav class="py-3">
                    <ul class="flex items-center">
                        <li class="topNave mr-4">
                            <router-link class="navLink text-juaso-primary" to="/help">
                        ...
                        <li class="topNave mr-4">
                            <router-link class="navLink text-juaso-primary" to="/buyer-protection">
                                <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.618 5.984A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016zM12 9v2m0 4h.01" />
                                </svg>
                                <span class="font-semibold">Buyer Protection</span>
                            </router-link>
                        </li>
                    </ul>
                </nav>
                ...
                <nav class="py-3">
                    <ul class="flex items-center">
                        ...
                        <li class="topNave mr-3">
                            <router-link class="navLink text-juaso-primary" to="/">
                                <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                </svg>
                                <span class="font-semibold">Sell on Juasoonline</span>
                            </router-link>
                        </li>
                        <li class="topNave mr-3">
                            <router-link class="navLink text-juaso-primary" to="/">
                        ...
                        <!-- Begin user link -->
                        <li class="topNave dropMenu group inline-block">

                            <!-- Begin account link -->
                            <a class="navLink text-juaso-primary cursor-pointer">
                                <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
