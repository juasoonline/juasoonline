<template>
    ...
    <!-- Begin contents -->
    <main class="container mx-auto my-4 md:w-screen sm:w-screen xs:w-screen">
        ...
        <section class="w-full">
            ...
            <!-- Begin items list -->
            <div class="grid 2xl:gap-4 xl:gap-4 lg:gap-4 md:gap-2 sm:gap-2 xs:gap-1 2xl:grid-cols-7 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 grid-cols-2">
                <div v-for="item in items" :key="item.resource_id" class="card bg-white rounded overflow-hidden shadow-md mt-2 hover:shadow-2xl">
            ...
            <div class="2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden my-10 flex justify-center">
                <button class="inline-block mr-1 px-7 py-2 text-xs font-medium leading-4 text-center text-white transition bg-red-500 rounded shadow ripple hover:bg-red-600">Load more</button>
            </div>
