<template>
    ...
    <div class="2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden">
        ...
        <div class="bg-white border-t">
            <div class="container mx-auto py-6 px-1.5">
                <div class="font-black text-3xl items-center flex">
                    <span class="mr-10 uppercase text-juaso-secondary">New Arrivals</span>
                    <span class="text-xl font-light">Hot new products at the best price!</span>
                </div>
            </div>
        </div>
        <!-- End page title -->
        ...
        <div class="bg-juaso-secondary sticky top-0 z-40 bg-white border-gray-100 text-white text-sm shadow-md">
        ...
        <main class="container mx-auto my-4 px-1.5">
            ...
            <div class="">
                ...
                <div id="infinite-list" class="grid gap-4 2xl:grid-cols-7 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2">
                    <div v-for="item in moreNewArrivals.items" :key="item.attributes.resource_id" class="card bg-white rounded overflow-hidden shadow-md hover:shadow-2xl">
    ...
    <div class="bg-bg-2 bg-cover 2xl:hidden xl:hidden lg:hidden md:block sm:block xs:block">

        <!-- Begin page header -->
        <div class="bg-bg-2 bg-cover sticky top-0 z-40 bg-cover py-3 px-1.5 text-white">
...
<script>
    ...
    export default
    {
        ...
        setup ()
        {
            ...
            const moreNewArrivals = reactive({ items: [], loaded: false })
            ...
            const getMoreNewArrivals = async () =>
            {
                currentPage.value++
                try
                {
                    ...
                    moreNewArrivals.items = [ ...moreNewArrivals.items, ...parsedResponse.data ]
                    totalPages.value = parsedResponse.meta.last_page
                    moreNewArrivals.loaded = true
                }
                catch( err )
                {
                    moreNewArrivals.loaded = false
                }
            }
            ...
            return { isLoading, menus, moreNewArrivals }
        }
    }
</script>
