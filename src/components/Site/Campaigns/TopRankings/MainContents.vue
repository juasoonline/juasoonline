<template>
    ...
    <div class="2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden">
        ...
        <div class="bg-white border-t">
            <div class="container mx-auto py-6 px-1.5">
                <div class="font-black text-3xl items-center flex">
                    <span class="mr-10 uppercase text-juaso-extra">Top Rankings</span>
                    <span class="text-gray-600 text-xl font-light">Juasoonline Official Ranking</span>
                </div>
            </div>
        </div>
        <!-- End page title -->
        ...
        <div class="bg-juaso-extra sticky top-0 z-40 bg-white border-gray-100 text-white text-sm shadow-md">
                ...
                <div class="">
                    <div class="flex overflow-x-auto">
                        ...
                        <div v-for="( menu ) in menus.group" :key="menu.attributes.resource_id" class="text-center px-10 py-4 border-r border-gray-100 hover:opacity-70 cursor-pointer">
                            ...
                            <p class="my-auto truncate mt-1">{{ menu.attributes.name }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="container mx-auto my-4 px-1.5">
            ...
            <div class="">
                ...
                <div id="infinite-list" class="grid gap-4 2xl:grid-cols-7 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2">
                    <div v-for="item in moreRankings.items" :key="item.attributes.resource_id" class="card bg-white rounded overflow-hidden shadow-md hover:shadow-2xl">
    ...
    <div class="bg-bg-3 bg-cover 2xl:hidden xl:hidden lg:hidden md:block sm:block xs:block">

        <!-- Begin page header -->
        <div class="bg-bg-3 bg-cover sticky top-0 z-40 bg-cover py-3 px-1.5 text-white">
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center text-lg font-black">
                    ...
                    <span class="ml-4">Top Rankings</span>
                </div>
                <div class="">
        ...
        <main class="mb-14 bg-gray-100 px-1.5">
            ...
            <!-- Begin title -->
            <div class="text-gray-600 text-xl font-black py-3"><p>More To Love</p></div>
            <!-- End title -->
...
<script>
    ...
    export default
    {
        ...
        setup ()
        {
            ...
            const moreRankings = reactive({ items: [], loaded: false })
            ...
            const getMoreProduct = async () =>
            {
                ...
                try
                {
                    ...
                    moreRankings.items = [ ...moreRankings.items, ...parsedResponse.data ]
                    totalPages.value = parsedResponse.meta.last_page
                    moreRankings.loaded = true
                }
                catch( err )
                {
                    moreRankings.loaded = false
                }
            }
            ...
            return { isLoading, menus, moreRankings }
        }
    }
</script>
