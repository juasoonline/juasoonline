<template>
    ...
    <div class="bg-white border-t">
        <div class="container mx-auto py-6 px-1.5">
            <div class="text-gray-600 font-black text-3xl items-center flex">
                <span class="mr-10 uppercase">Top Rankings</span>
    ...
    <main class="container mx-auto my-4 px-1.5">
        ...
        <div class="">
            ...
            <!-- Begin title -->
            <div class="text-gray-600 text-xl font-black mb-3"><p>More To Love</p></div>
            <!-- End title -->
            ...
            <div id="infinite-list" class="grid gap-4 2xl:grid-cols-7 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2">
                <div v-for="item in moreProduct.items" :key="item.attributes.resource_id" class="card bg-white rounded overflow-hidden shadow-md hover:shadow-2xl">
                    <router-link class="w-full object-cover" :to="{ name: 'Item', params: { item: item.attributes.resource_id }}">
                        <img class="object-cover h-48 w-full" v-bind:src="item.attributes.image" alt="">
                    </router-link>
                    <div class="m-2">
...
<script>
    ...
    export default
    {
        ...
        setup ()
        {
            ...
            const moreProduct = reactive({ items: [], loaded: false })
            ...
            const getMoreProduct = async () =>
            {
                ...
                try
                {
                    ...
                    moreProduct.items = [ ...moreProduct.items, ...parsedResponse.data ]
                    totalPages.value = parsedResponse.meta.last_page
                    moreProduct.loaded = true
                }
                catch( err )
                {
                    moreProduct.loaded = false
                }
            }
            ...
            return { isLoading, menus, moreProduct }
        }
    }
</script>
