<template>
    ...
    <div class="2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden">
        ...
        <div class="bg-white border-t">
            <div class="container mx-auto py-6 px-1.5">
                <div class="flex text-gray-600 font-black text-3xl items-center">
                    <span class="mr-10 uppercase">Flash Deals</span>
    ...
    <div class="bg-flash_bg 2xl:hidden xl:hidden lg:hidden md:block sm:block xs:block">

        <!-- Begin page header -->
        <div class="bg-flash_bg sticky top-0 z-40 bg-cover py-3 px-1.5 text-white -mt-0.5">

            <!-- Begin title section -->
            <div class="flex justify-between items-center">
                <div class="flex items-center text-lg font-black">
                    <router-link to=""><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" /></svg></router-link>
        ...
        <!-- Begin main contents -->
        <main class="mb-14 bg-gray-100 px-1.5 rounded-t-lg">
