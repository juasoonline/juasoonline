<template>
    ...
    <div class="">
        ...
        <div class="bg-white sticky top-0 z-40 border-t border-b border-gray-100 text-gray-600 text-sm">
        ...
        <!-- Begin banner -->
        <div class="">
            <img src="https://juasoonline.nyc3.digitaloceanspaces.com/test/images/ads/promotions/juasoonline_lunch_sales.jpg" alt="">
        </div>
        <!-- End banner -->
