<template>
    ...
    <div class="bg-black">
        ...
        <!-- Begin banner -->
        <div class=""><img src="https://juasoonline.nyc3.digitaloceanspaces.com/test/images/ads/promotions/juasoonline_lunch_sales.jpg" alt=""></div>
        <!-- End banner -->

        <!-- Begin main contents -->
        <div class="container mx-auto px-1.5 h-screen">

            <!-- Begin categories menu -->
            <div class="sticky top-0 z-40 bg-white border-t border-gray-100 text-gray-600 rounded shadow-md">
