            ...
            <div class="col-span-2">
                ...
                <div class="bg-white border">
                    ...
                    <ul class="list-reset">
                        ...
                        <li><router-link to="change-password" class="block p-2.5 text-xs text-grey-darker hover:bg-juaso-extra hover:text-white border-l-2 border-juaso-primary">Change Password</router-link></li>
            ...
            <div class="col-span-10 border bg-white">
                <div class="p-4 flex grid grid-cols-12 gap-10">
                    ...
                    <div class="col-span-10">
                        ...
                        <!-- Begin title -->
                        <div class="text-lg text-gray-600">Change Password</div>
                        <!-- End title -->
