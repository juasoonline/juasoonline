            ...
            <div class="px-2 mx-auto">
                ...
                <div class="mt-3">
                    <div class="bg-white rounded">
                        <div class="border-b">
                            <router-link to="orders" class="flex text-xs items-center p-3 cursor-pointer">
                    ...
                    <div class="bg-white rounded mt-3">
                        <div class="border-b">
                            <div to="orders" class="flex text-xs items-center p-3 cursor-pointer">
                                <span class="font-bold text-sm">My Account</span>
                            </div>
                        </div>
                        <div class="border-b">
                            <router-link to="" class="flex text-xs items-center p-3 cursor-pointer">
